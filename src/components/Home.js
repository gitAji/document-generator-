            ...
            <Col md={4}>
              <Card className="h-100 shadow-sm" style={{ backgroundColor: 'var(--background-color)' }}>
                <Card.Body className="d-flex flex-column">
                  ...
                  <Button variant="outline-primary" as={Link} to="/youtube-generator" className="mt-auto">Go to Service</Button>
                </Card.Body>
              </Card>
            </Col>
            <Col md={4}>
              <Card className="h-100 shadow-sm" style={{ backgroundColor: 'var(--background-color)' }}>
                <Card.Body className="d-flex flex-column">
                  ...
                  <Button variant="outline-primary" as={Link} to="/speak-to-write" className="mt-auto">Go to Service</Button>
                </Card.Body>
              </Card>
            </Col>
            <Col md={4}>
              <Card className="h-100 shadow-sm" style={{ backgroundColor: 'var(--background-color)' }}>
                <Card.Body className="d-flex flex-column">
                  ...
                  <Button variant="outline-primary" as={Link} to="/upload-edit" className="mt-auto">Go to Service</Button>
                </Card.Body>
              </Card>
            </Col>
            <Col md={4}>
              <Card className="h-100 shadow-sm" style={{ backgroundColor: 'var(--background-color)' }}>
                <Card.Body className="d-flex flex-column">
                  ...
                  <Button variant="outline-primary" as={Link} to="/image-resizer" className="mt-auto">Go to Service</Button>
                </Card.Body>
              </Card>
            </Col>
            <Col md={4}>
              <Card className="h-100 shadow-sm" style={{ backgroundColor: 'var(--background-color)' }}>
                <Card.Body className="d-flex flex-column">
                  ...
                  <Button variant="outline-primary" as={Link} to="/audio-trimmer" className="mt-auto">Go to Service</Button>
                </Card.Body>
              </Card>
            </Col>
            <Col md={4}>
              <Card className="h-100 shadow-sm" style={{ backgroundColor: 'var(--background-color)' }}>
                <Card.Body className="d-flex flex-column">
                  ...
                  <Button variant="outline-primary" as={Link} to="/quote-maker" className="mt-auto">Go to Service</Button>
                </Card.Body>
              </Card>
            </Col>
            <Col md={4}>
              <Card className="h-100 shadow-sm" style={{ backgroundColor: 'var(--background-color)' }}>
                <Card.Body className="d-flex flex-column">
                  ...
                  <Button variant="outline-primary" as={Link} to="/youtube-thumbnail-analyzer" className="mt-auto">Go to Service</Button>
                </Card.Body>
              </Card>
            </Col>
            <Col md={4}>
              <Card className="h-100 shadow-sm" style={{ backgroundColor: 'var(--background-color)' }}>
                <Card.Body className="d-flex flex-column">
                  ...
                  <Button variant="outline-primary" as={Link} to="/engagement-rate-calculator" className="mt-auto">Go to Service</Button>
                </Card.Body>
              </Card>
            </Col>
            <Col md={4}>
              <Card className="h-100 shadow-sm" style={{ backgroundColor: 'var(--background-color)' }}>
                <Card.Body className="d-flex flex-column">
                  ...
                  <Button variant="outline-primary" as={Link} to="/favicon-tool" className="mt-auto">Go to Service</Button>
                </Card.Body>
              </Card>
            </Col>
            <Col md={4}>
